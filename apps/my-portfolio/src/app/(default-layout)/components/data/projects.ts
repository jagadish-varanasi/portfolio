export const projects = [
  ...
  },
  {
    ...
    title: "JSBlitz",
    description:
      "JSBlitz is a modern, interactive JavaScript playground with real-time preview and console output.",
    icon: "/jsblitz.svg",
    url: process.env.JSBLITZ,
  },
  {
    id: "4",
    title: "DrawIt",
  ...
  },
  {
    ...
    title: "CodeX",
    description:
      "Collection of frequently asked react and vanilla JS machine coding problems and implementation!",
    icon: "/codex.svg",
    url: process.env.CODEX,
  },
];
